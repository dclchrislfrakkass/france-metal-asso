<?php
	...
	if( !class_exists('Wbcr_FactoryForms411_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms411_Control extends Wbcr_FactoryForms411_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms411_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms411_ValueProvider $provider
			 * @return void
			 */
