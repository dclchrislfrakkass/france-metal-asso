<?php
	...
	if( !class_exists('Wbcr_FactoryForms411_Holder') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms411_Holder extends Wbcr_FactoryForms411_FormElement {

			/**
			 * Holder Elements.
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms411_Control[]
			 */
			...
			function render()
			{
				...
				foreach($this->elements as $element) {
					...
					do_action('wbcr_factory_410_form_before_element_' . $element->getOption('name'));
