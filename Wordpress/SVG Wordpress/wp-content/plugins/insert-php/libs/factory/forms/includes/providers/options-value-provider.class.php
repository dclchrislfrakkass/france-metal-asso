<?php
	...
	if( !class_exists('Wbcr_FactoryForms411_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms411_OptionsValueProvider implements Wbcr_IFactoryForms411_ValueProvider {
