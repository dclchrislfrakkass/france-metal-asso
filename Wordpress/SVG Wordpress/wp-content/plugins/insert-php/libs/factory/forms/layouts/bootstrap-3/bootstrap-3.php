<?php
	...
	if( !class_exists('Wbcr_FactoryForms411_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms411_Bootstrap3FormLayout extends Wbcr_FactoryForms411_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms411_Control $control
			 */
