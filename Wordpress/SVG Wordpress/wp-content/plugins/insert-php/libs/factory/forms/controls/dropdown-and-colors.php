<?php
	 ...
	 *  // see FactoryForms411_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms411_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms411_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms411_DropdownAndColorsControl extends Wbcr_FactoryForms411_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms411_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms411_RadioColorsControl($options['colors'], $form, $provider);
