<?php
	...
	add_action('wbcr_factory_forms_411_plugin_created', 'wbcr_factory_forms_411_plugin_created');

	function wbcr_factory_forms_411_plugin_created($plugin)
	{
		$plugin->forms = new Wbcr_FactoryForms411_Manager($plugin);
	}

	if( !class_exists('Wbcr_FactoryForms411_Manager') ) {

		class Wbcr_FactoryForms411_Manager {
			 ...
			 *
			 * @see FactoryForms411_Form::registerControl()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms411_Form::registerHolder()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms411_Form::registerCustomElement()
			 *
			 * @since 1.0.0
			 * @return void
			 */
	...
	if( !class_exists('Wbcr_FactoryForms411_Form') ) {
		/**
		 * An abstraction for forms.
		 */
		class Wbcr_FactoryForms411_Form {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_IFactoryForms411_ValueProvider
			 */
			private $provider;
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms411_FormLayout
			 */
			public $layout;
			 ...
			 */
			public function __construct(array $options = array(), Wbcr_Factory410_Plugin $plugin)
			{
				// register controls once, when the first form is created
				if( !Wbcr_FactoryForms411_Manager::$controls_registered ) {

					do_action('wbcr_factory_forms_411_register_controls', $plugin);

					//if( !empty($plugin) ) {
					do_action('wbcr_factory_forms_411_register_controls_' . $plugin->getPluginName(), $plugin);
					//}

					Wbcr_FactoryForms411_Manager::$controls_registered = true;
				}
				...
				Wbcr_FactoryForms411_Manager::$temper = 'flat';
			}
			 ...
			 *
			 * @since 1.0.0
			 * @param Wbcr_IFactoryForms411_ValueProvider $provider
			 * @return void
			 */
			...
			{
				return apply_filters('wbcr_factory_410_form_items', $this->items, $this->name);
			}
			 ...
			 *
			 * @since 1.0.0
			 * @return Wbcr_FactoryForms411_Control[]
			 */
			 ...
			 * @return Wbcr_FactoryForms411_FormElement|null A form element.
			 */
			 ...
			 * @return Wbcr_FactoryForms411_FormElement[] Created elements.
			 */
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms411_Control A control object.
			 */
			public function createControl($item)
			{
				...
				if( is_array($item) ) {
					...
					$control_data = Wbcr_FactoryForms411_Manager::$registered_controls[$item['type']];
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms411_Holder A control holder object.
			 */
			public function createHolder($item)
			{
				...
				if( is_array($item) ) {
					...
					$holderData = Wbcr_FactoryForms411_Manager::$registered_holders[$item['type']];
			 ...
			 * @return Wbcr_FactoryForms411_FormElement A custom form element object.
			 */
			public function createCustomElement($item)
			{
				...
				if( is_array($item) ) {
					...
					$data = Wbcr_FactoryForms411_Manager::$registered_custom_elements[$item['type']];
			...
			public function html($options = array())
			{
				...
				if( !isset(Wbcr_FactoryForms411_Manager::$form_layouts[$this->form_layout]) ) {
					die(sprintf('[ERROR] The form layout %s was not found.', $this->form_layout));
				}

				// include a render code
				$layout_data = Wbcr_FactoryForms411_Manager::$form_layouts[$this->form_layout];
			...
			public static function connectAssetsForItem($item)
			{
				...
				if( self::isControl($type) ) {
					$haystack = Wbcr_FactoryForms411_Manager::$registered_controls;
				} elseif( self::isControlHolder($type) ) {
					$haystack = Wbcr_FactoryForms411_Manager::$registered_holders;
				}
			...
			{
				return isset(Wbcr_FactoryForms411_Manager::$registered_controls[$item['type']]);
			}
			...
			{
				return isset(Wbcr_FactoryForms411_Manager::$registered_holders[$item['type']]);
			}
			...
			{
				return isset(Wbcr_FactoryForms411_Manager::$registered_custom_elements[$item['type']]);
			}
		}
	}