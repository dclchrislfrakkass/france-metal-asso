<?php
	...
	if( !class_exists('Wbcr_Factory410_AssetsList') ) {
		/**
		 * Assets List
		 *
		 * @since 1.0.0
		 */
		class Wbcr_Factory410_AssetsList {
			 ...
			 */
			public function __construct(Wbcr_Factory410_Plugin $plugin, $defaultIsFooter = true)
			{
				$this->plugin = $plugin;
