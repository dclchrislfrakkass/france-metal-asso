...
if ( ! class_exists( 'Wbcr_Factory410_Base' ) ) {
	class  Wbcr_Factory410_Base {
		...
		/**
		 * Экзамеляр класса Wbcr_Factory410_Request, необходим управляет http запросами
		 *
		 * @var Wbcr_Factory410_Request
		 */
		public $request;
		...
		public function __construct( $plugin_path, $data ) {
			$this->request = new Wbcr_Factory410_Request();
