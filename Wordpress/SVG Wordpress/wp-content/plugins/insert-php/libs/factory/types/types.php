<?php
	...
	if( !class_exists('Wbcr_FactoryTypes405') ) {
		...
		add_action('wbcr_factory_410_plugin_activation', 'Wbcr_FactoryTypes405::activationHook');
		add_action('wbcr_factory_410_plugin_deactivation', 'Wbcr_FactoryTypes405::deactivationHook');
		...
		class Wbcr_FactoryTypes405 {
			 ...
			 */
			public static function register($class_name, Wbcr_Factory410_Plugin $plugin = null)
			{
			 ...
			 * @return void
			 */
			public static function activationHook(Wbcr_Factory410_Plugin $plugin)
			{
			 ...
			 * @return void
			 */
			public static function deactivationHook(Wbcr_Factory410_Plugin $plugin)
			{
