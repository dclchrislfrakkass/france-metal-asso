<?php
	...
	//add_action('factory_410_plugin_activation', 'FactoryTaxonomy000::activationHook');
	//add_action('factory_410_plugin_deactivation', 'FactoryTaxonomy000::deactivationHook');
	...
	if( !class_exists('Wbcr_FactoryTaxonomies325') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryTaxonomies325 {

			/**
			 * Registered custom types.
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryTaxonomies325_Taxonomy[]
			 */
