...
<div id="pms-settings-emails">
    ...
    <div data-sub-tab-slug="user_emails" class="pms-sub-tab pms-sub-tab-user <?php echo ( $active_sub_tab == 'user_emails' ? 'tab-active' : '' ); ?>">
        ...
        <?php else : ?>
            ...
            <?php printf( __( 'You can <a href="%s">customize this email</a> with Profile Builder Email Customizer', 'paid-member-subscriptions' ), admin_url( 'admin.php?page=user-email-customizer' ) )?>
