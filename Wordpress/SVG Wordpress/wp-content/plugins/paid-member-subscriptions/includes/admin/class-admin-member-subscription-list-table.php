...
Class PMS_Member_Subscription_List_Table extends WP_List_Table {
    ...
    public function get_table_data() {
        ...
        $member_subscriptions = pms_get_member_subscriptions( array( 'user_id' => $this->member->user_id ) );
    ...
    public function column_expiration_date( $item ) {
        ...
        $output = '<span>' . ( ! empty( $item['expiration_date'] ) ? $item['expiration_date'] : __( 'Unlimited', 'paid-member-subscriptions' ) ) . '</span>';
