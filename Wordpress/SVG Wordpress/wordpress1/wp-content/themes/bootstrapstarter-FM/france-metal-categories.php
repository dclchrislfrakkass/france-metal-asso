        ...
        while ($row = $req->fetch()){
            ...
            <div class="card col-sm-12 col-md-5 col-xl-3 m-1"> 
                ...
                <div class="view overlay">
                    <a href="http://localhost/projects/wp1/wordpress/index.php/groupes/?nom=<?php echo $nomStyle;?>"><img class="card-img-top" src="<?php echo $row['illustration'];?>" alt="Card image cap"></a>
            ...
            <!-- Card content -->
                <div class="card-body cadre_info_categorie text-center">
                    ...
                    <!-- Button -->
                    <a href="http://localhost/projects/wp1/wordpress/index.php/groupes/?nom=<?php echo $nomStyle;?>" class="bouton_categorie btn btn-danger w-100">Entrer dans cette catégorie</a>
                </div>  
            </div>
        <?php
        }
