<?php
	 ...
	 * @since 1.0.0
	 */
	if( !class_exists('Wbcr_FactoryNotices408') ) {

		class Wbcr_FactoryNotices408 {
			...
			{
				add_action('wbcr_factory_notices_408_plugin_created', array($this, 'init'));
			}

			/**
			 * @param Wbcr_Factory410_Plugin $plugin
			 */
			public function init(Wbcr_Factory410_Plugin $plugin)
			{
				//default notices
				//---
			...
			{
				$this->notices = apply_filters('wbcr_factory_notices_408_list', $this->notices, $this->plugin->getPluginName());

				$this->notices = wbcr_factory_410_apply_filters_deprecated('wbcr_factory_admin_notices', array(
					$this->notices,
					$this->plugin->getPluginName()
				), '4.0.5', 'wbcr_factory_notices_408_list');
