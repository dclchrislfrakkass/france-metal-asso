...
<div class="pms-form-fields">
    ...
    <div class="pms-form-field-wrapper">
        ...
        <?php if ( isset( $this->options['register_success_page'] ) ) : ?>
            <a class="button" href="<?php echo get_permalink( $this->options['register_success_page'] ); ?>" target="_blank">View</a>
            <a class="button" href="<?php echo admin_url( 'post.php?post='. $this->options['register_success_page'] .'&action=edit' ); ?>" target="_blank">Edit</a>
        <?php endif; ?>
    ...
    <div class="pms-form-field-wrapper">
        ...
        <?php if ( isset( $this->options['login_page'] ) ) : ?>
            <a class="button" href="<?php echo get_permalink( $this->options['login_page'] ); ?>" target="_blank">View</a>
            <a class="button" href="<?php echo admin_url( 'post.php?post='. $this->options['login_page'] .'&action=edit' ); ?>" target="_blank">Edit</a>
        <?php endif; ?>
    ...
    <div class="pms-form-field-wrapper">
        ...
        <?php if ( isset( $this->options['register_page'] ) ) : ?>
            <a class="button" href="<?php echo get_permalink( $this->options['register_page'] ); ?>" target="_blank">View</a>
            <a class="button" href="<?php echo admin_url( 'post.php?post='. $this->options['register_page'] .'&action=edit' ); ?>" target="_blank">Edit</a>
        <?php endif; ?>
    ...
    <div class="pms-form-field-wrapper">
        ...
        <?php if ( isset( $this->options['account_page'] ) ) : ?>
            <a class="button" href="<?php echo get_permalink( $this->options['account_page'] ); ?>" target="_blank">View</a>
            <a class="button" href="<?php echo admin_url( 'post.php?post='. $this->options['account_page'] .'&action=edit' ); ?>" target="_blank">Edit</a>
        <?php endif; ?>
    ...
    <div class="pms-form-field-wrapper">
        ...
        <?php if ( isset( $this->options['lost_password_page'] ) ) : ?>
            <a class="button" href="<?php echo get_permalink( $this->options['lost_password_page'] ); ?>" target="_blank">View</a>
            <a class="button" href="<?php echo admin_url( 'post.php?post='. $this->options['lost_password_page'] .'&action=edit' ); ?>" target="_blank">Edit</a>
        <?php endif; ?>
