...
<div class="wrap">
    ...
    <form id="pms-form-edit-payment" class="pms-form" method="POST" action="<?php echo admin_url( 'admin.php?page=pms-payments-page' ); ?>">
        ...
        <div class="pms-form-field-wrapper">
            ...
            <input type="text" id="pms-payment-transaction-id" name="pms-payment-transaction-id" class="widefat" value="<?php echo ( ! empty( $payment->transaction_id ) ? esc_attr( $payment->transaction_id ) : '' ); ?>" />

            <?php if( empty( $payment->transaction_id ) && $payment->payment_gateway != 'manual' ): ?>
