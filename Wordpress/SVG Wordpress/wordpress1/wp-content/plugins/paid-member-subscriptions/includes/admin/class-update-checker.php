...
if ( ! class_exists( 'pms_PluginUpdateChecker' ) ):
    ...
    class pms_PluginUpdateChecker {
        ...
        function installHooks(){
            ...
            // add_filter('init', array(&$this, 'checkForUpdates') );
        ...
        function requestInfo($queryArgs = array()){
            ...
            if ( !is_wp_error($result) && isset($result['response']['code']) && ($result['response']['code'] == 200) && !empty($result['body']) ){
                $pluginInfo = PMSPluginInfo::fromJson( $result['body'], $this->pluginFile );
            }
         ...
         *
         * @return PMSPluginUpdate An instance of PMSPluginUpdate, or NULL when no updates are available.
         */
        ...
        function injectUpdate($updates){
            ...
            if ( isset( $state->update) && !is_null( $state->update ) ) {
                $class = get_class( $state->update );

                if ( $class == '__PHP_Incomplete_Class' || $class == 'PluginUpdate' ) {
                    $this->checkForUpdates();
                    wp_cache_delete( $this->optionName );
                    $state = get_option( $this->optionName );
                }
            }
...
if ( !class_exists( 'PMSPluginInfo' ) ) :
    ...
    class PMSPluginInfo {
        ...
        /**
         * Create a new instance of PMSPluginInfo from JSON-encoded plugin info
         * returned by an external update API.
         *
         * @param string $json Valid JSON string representing plugin info.
         * @return PMSPluginInfo New instance of PMSPluginInfo, or NULL on error.
         */
        public static function fromJson( $json, $plugin_file ){
        ...
        public function toWpFormat() {
            ...
            $sameFormat = array(
                'name', 'slug', 'plugin', 'version', 'requires', 'tested', 'rating', 'upgrade_notice',
...
if ( !class_exists('PMSPluginUpdate') ):
    ...
    class PMSPluginUpdate {
        ...
        /**
         * Create a new instance of PMSPluginUpdate from its JSON-encoded representation.
         *
         * @param string $json
         * @return PMSPluginUpdate
         */
        public static function fromJson( $json ) {
            //Since update-related information is simply a subset of the full plugin info,
            //we can parse the update JSON as if it was a plugin info string, then copy over
            //the parts that we care about.
            $pluginInfo = PMSPluginInfo::fromJson( $json );
        ...
        /**
         * Create a new instance of PMSPluginUpdate based on an instance of PMSPluginInfo.
         * Basically, this just copies a subset of fields from one object to another.
         *
         * @param PMSPluginInfo $info
         * @return PMSPluginUpdate
         */
        public static function fromPluginInfo( $info ){
            $update = new PMSPluginUpdate();

            $copyFields = array( 'id', 'slug', 'plugin', 'version', 'homepage', 'download_url', 'upgrade_notice' );
