    ...
    <form method="POST" action="options.php">
        ...
        <div class="pms-tab-wrapper">
            ...
            <div id="pms-settings-general" class="pms-tab <?php echo ( $active_tab == 'general' ? 'tab-active' : '' ); ?>">
                ...
                <div class="pms-form-field-wrapper">
                    <label class="pms-form-field-label" for="automatically-log-in"><?php echo __( 'Automatically Log In', 'paid-member-subscriptions' ) ?></label>

                    <select id="automatically-log-in" name="pms_settings[general][automatically_log_in]" >
                        <option value="0" <?php ( isset( $this->options['general']['automatically_log_in'] ) ? selected( $this->options['general']['automatically_log_in'], '0', true ) : ''); ?> ><?php echo __( 'No', 'paid-member-subscriptions' ) ?></option>
                        <option value="1" <?php ( isset( $this->options['general']['automatically_log_in'] ) ? selected( $this->options['general']['automatically_log_in'], '1', true ) : ''); ?> ><?php echo __( 'Yes', 'paid-member-subscriptions' ) ?></option>
                    </select>

                    <p class="description"><?php echo __( 'Select "Yes" to automatically log in new members after successful registration.', 'paid-member-subscriptions' ); ?></p>
                </div>
                    ...
                    if( count( $payment_gateways ) > 1 ) {
                        ...
                        if( pms_payment_gateways_support( pms_get_payment_gateways( true ), 'recurring_payments' ) ) {
                            ...
                            echo '<div class="pms-form-field-wrapper">';
                                ...
                                echo '<select id="payment-recurring" name="pms_settings[payments][recurring]" class="widefat">';

                                    echo '<option value="1" ' . ( isset( $this->options['payments']['recurring'] ) && ( $this->options['payments']['recurring'] == 1 ) ? 'selected' : '' ) . '>' . __( 'Customer opts in for automatic renewal', 'paid-member-subscriptions' ) . '</option>';
                                    echo '<option value="2" ' . ( isset( $this->options['payments']['recurring'] ) && ( $this->options['payments']['recurring'] == 2 ) ? 'selected' : '' ) . '>' . __( 'Always renew automatically', 'paid-member-subscriptions' ) . '</option>';
                                    echo '<option value="3" ' . ( isset( $this->options['payments']['recurring'] ) && ( $this->options['payments']['recurring'] == 3 ) ? 'selected' : '' ) . '>' . __( 'Never renew automatically', 'paid-member-subscriptions' ) . '</option>';
            ...
            <div id="pms-settings-content-restriction" class="pms-tab <?php echo ( $active_tab == 'content-restriction' ? 'tab-active' : '' ); ?>">
                ...
                <div class="pms-form-field-wrapper">
                    ...
                    <p class="description"><?php echo __( 'If you select "Template" the template for the restricted post/page will change to the selected template in the Restriction Template section below.', 'paid-member-subscriptions' ); ?></p>
                </div>

                <!-- Redirect URL -->
                <h3><?php echo __( 'Restriction Redirect', 'paid-member-subscriptions' ); ?></h3>
                ...
                <!-- Restrict Messages -->
                <h3><?php echo __( 'Restriction Messages', 'paid-member-subscriptions' ); ?></h3>
                ...
                <!-- Template Restrict -->
                <h3><?php echo __( 'Restriction Template', 'paid-member-subscriptions' ); ?></h3>
                ...
                <div class="pms-form-field-wrapper">
                    ...
                    <select id="pms-content-restriction-template-select" name="<?php echo $this->settings_slug . '[content_restrict_template]'; ?>">
                    ...
                    <p class="description"><?php echo __( 'Select which template should load instead of the default one when a post is restricted and the restriction type is set to "Template".', 'paid-member-subscriptions' ); ?></p>
                </div>


                <h3><?php echo __( 'Misc', 'paid-member-subscriptions' ); ?></h3>
            ...
            <div id="pms-settings-emails" class="pms-tab <?php echo ( $active_tab == 'emails' ? 'tab-active' : '' ); ?>">
                ...
                <ul class="pms-nav-sub-tab-wrapper subsubsub">
                    <li><a data-sub-tab-slug="user_emails"  href="<?php echo admin_url( add_query_arg( array( 'page' => 'pms-settings-page', 'nav_tab' => 'emails', 'nav_sub_tab' => 'user_emails' ), 'admin.php' ) ); ?>" class="nav-sub-tab <?php echo ( $active_sub_tab == 'user_emails' ? 'current' : '' ) ?>"><?php echo __( 'Member Emails', 'paid-member-subscriptions' ); ?></a> | </li>
                    <li><a data-sub-tab-slug="admin_emails" href="<?php echo admin_url( add_query_arg( array( 'page' => 'pms-settings-page', 'nav_tab' => 'emails', 'nav_sub_tab' => 'admin_emails' ), 'admin.php' ) ); ?>" class="nav-sub-tab <?php echo ( $active_sub_tab == 'admin_emails' ? 'current' : '' ) ?>"><?php echo __( 'Administrator Emails', 'paid-member-subscriptions' ); ?></a></li>
                </ul>
                ...
                <!-- User Emails Sub Tab -->
                <div data-sub-tab-slug="user_emails" class="pms-sub-tab <?php echo ( $active_sub_tab == 'user_emails' ? 'tab-active' : '' ); ?>">
    	            ...
    	            <?php if( ! ( defined( 'PROFILE_BUILDER' ) && PROFILE_BUILDER == 'Profile Builder Pro' && ! empty( $wppb_addonOptions['wppb_emailCustomizer'] ) && $wppb_addonOptions['wppb_emailCustomizer'] == 'show' ) ) { ?>
    	                ...
    	                <div class="pms-form-field-wrapper">
    	                    ...
    	                    <?php wp_editor( ( isset($this->options['emails']['register_sub']) ? $this->options['emails']['register_sub'] : $email_content['register'] ), 'emails_register_sub', array( 'textarea_name' => $this->settings_slug . '[emails][register_sub]', 'editor_height' => 250 ) ); ?>
    	                </div>
    	            <?php }else{ ?>
                ...
                <div data-sub-tab-slug="admin_emails" class="pms-sub-tab <?php echo ( $active_sub_tab == 'admin_emails' ? 'tab-active' : '' ); ?>">
                    ...
                    <div class="pms-form-field-wrapper">
                        <label class="pms-form-field-label" for="emails-admin-on"><?php echo __( 'Send Administrator Emails', 'paid-member-subscriptions' ) ?></label>
                        <p class="description"><input type="checkbox" id="emails-admin-on" name="pms_settings[emails][admin_emails_on]" value="1" <?php echo ( isset( $this->options['emails']['admin_emails_on'] ) ? 'checked' : '' ); ?> /><?php echo __( 'By checking this option the administrator email addresses from the field below wil receive email notifications.', 'paid-member-subscriptions' ); ?></p>
                    </div>

                    <div class="pms-form-field-wrapper">
                        <label class="pms-form-field-label" for="emails-admin"><?php echo __( 'Administrator Emails', 'paid-member-subscriptions' ); ?></label>
                        <input type="text" id="emails-admin" class="widefat" name="<?php echo $this->settings_slug ?>[emails][admin_emails]" value="<?php echo ( isset($this->options['emails']['admin_emails']) ? esc_attr( $this->options['emails']['admin_emails'] ) : '' ); ?>">
                        <p class="description"><?php echo __( 'Please add a list of email addresses, separated by comma, that you wish to receive emails for member subscription status changes.', 'paid-member-subscriptions' ); ?></p>
                    </div>
                    ...
                    <?php if( ! ( defined( 'PROFILE_BUILDER' ) && PROFILE_BUILDER == 'Profile Builder Pro' && ! empty( $wppb_addonOptions['wppb_emailCustomizer'] ) && $wppb_addonOptions['wppb_emailCustomizer'] == 'show' ) ) { ?>
                        <div class="pms-form-field-wrapper">
                            <label class="pms-form-field-label" for="email-register-subject"><?php echo __( 'Subject', 'paid-member-subscriptions' ) ?></label>
                            <input type="text" id="email-register-subject" class="widefat" name="<?php echo $this->settings_slug ?>[emails][register_sub_subject_admin]" value="<?php echo ( isset($this->options['emails']['register_sub_subject_admin']) ? esc_attr( $this->options['emails']['register_sub_subject_admin'] ) : esc_attr( $email_subjects['register'] ) ) ?>">
                        </div>

                        <div class="pms-form-field-wrapper">
                            <label class="pms-form-field-label" for="emails_register_sub"><?php echo __( 'Content', 'paid-member-subscriptions' ) ?></label>
                            <?php wp_editor( ( isset( $this->options['emails']['register_sub_admin'] ) ? $this->options['emails']['register_sub_admin'] : $email_content['register'] ), 'emails_register_sub_admin', array( 'textarea_name' => $this->settings_slug . '[emails][register_sub_admin]', 'editor_height' => 250 ) ); ?>
                        </div>
                    <?php }else{ ?>
                        <?php printf( __( 'You can <a href="%s">customize this email</a> with Profile Builder Email Customizer', 'pmstext' ), admin_url( 'admin.php?page=user-email-customizer' ) )?>
                    <?php } ?>
                    ...
                    <?php foreach( $email_actions as $action ): ?>
                        ...
                        <div class="pms-form-field-wrapper">
                            <label class="pms-form-field-label" for="email-<?php echo $action ?>-sub-subject-admin"><?php echo __( 'Subject', 'paid-member-subscriptions' ) ?></label>
                            <input type="text" id="email-<?php echo $action ?>-sub-subject-admin" class="widefat" name="<?php echo $this->settings_slug ?>[emails][<?php echo $action ?>_sub_subject_admin]" value="<?php echo ( isset($this->options['emails'][$action.'_sub_subject_admin']) ? esc_attr( $this->options['emails'][$action.'_sub_subject_admin'] ) : esc_attr( $email_subjects[$action] ) ); ?>">
                        </div>

                        <div class="pms-form-field-wrapper">
                            <label class="pms-form-field-label" for="emails-<?php echo $action ?>-sub-admin"><?php echo __( 'Content', 'paid-member-subscriptions' ) ?></label>
                            <?php wp_editor( ( isset($this->options['emails'][$action.'_sub_admin']) ? $this->options['emails'][$action.'_sub_admin'] : $email_content[$action] ), 'emails-'. $action .'-sub-admin', array( 'textarea_name' => $this->settings_slug . '[emails]['.$action.'_sub_admin]', 'editor_height' => 250 ) ); ?>
                        </div>
