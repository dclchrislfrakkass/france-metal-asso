...
<p><i class="fas fa-exclamation-triangle text-danger"></i> STYLE SECONDAIRE / NOM DE GROUPE / TITRE  ALBUM / CLIP TITRE  <i class="fas fa-exclamation-triangle text-danger"></i>  OBLIGATOIRE</p>
            </div>
