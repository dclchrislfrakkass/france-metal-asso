...
$templates_data_html['email_confirmed'] = '<div style="background: #f5f5f5; color: #333; font-size: 14px; line-height: 20px; font-family: Arial, sans-serif;">
...
<p style="font-size: 14px; line-height: 20px; color: #333; font-family: Arial, sans-serif;">{user_name} s\'est joint avec succès à  {site_name}</p>
